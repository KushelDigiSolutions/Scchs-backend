    ...
    public function store(Request $request)
{
    ...
    $validatedData = $request->validate([
        ...
        'text_link_color' => 'nullable|string|max:20',
        'hover_background_color' => 'nullable|string|max:20',
        'link_hover_color' => 'nullable|string|max:20',
        'parent_text_color' => 'nullable|string|max:20',
        'parent_text_hover_color' => 'nullable|string|max:20',
        'storeObjectItems' => 'required|array|min:1', // Must be an array with at least one item
        'storeObjectItems.*' => 'required|string', // Each item in the array must be a string
        'is_active' => 'required|boolean',
    ], [
        'storeObjectItems.required' => 'Item not added. Please add at least one item.',
    ...
    $navigation->background_color = $validatedData['background_color'] ?? null;
    $navigation->text_link_color = $validatedData['text_link_color'] ?? null;
    $navigation->hover_background_color = $validatedData['hover_background_color'] ?? null;
    $navigation->link_hover_color = $validatedData['link_hover_color'] ?? null;
    $navigation->parent_text_color = $validatedData['parent_text_color'] ?? null;
    $navigation->parent_text_hover_color = $validatedData['parent_text_hover_color'] ?? null;
