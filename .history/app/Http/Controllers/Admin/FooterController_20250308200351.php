...
class FooterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'txtColorCode' => 'required|string|max:20',
            'global_title_text' => 'required|string|max:255',
            'sub_title' => 'required|string|max:255',
            'parent_text_color' => 'required|string|max:20',
            'parent_text_hover_color' => 'required|string|max:20',
            'footer_logo' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048',
            'storeObjectItems' => 'required|array',
            'is_active' => 'required|in:1,0', // ENUM validation
        ]);
