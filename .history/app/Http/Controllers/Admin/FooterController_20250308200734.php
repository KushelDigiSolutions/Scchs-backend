...
class FooterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'title' => 'required',
            'txtColorCode' => 'requiredsingmtrax:20',
            'global_title_text' => 'required',
            'sub_title' => 'required',
            'parent_text_color' => 'requiredstringmax:20',
            'parent_text_hover_color' => 'requiredstringmax:20',
            'footer_logo' => 'requiredimagemimes:jpeg,png,jpg,gifmax:2048',
            'storeObjectItems' => 'requiredarray',
            'is_active' => 'requiredin:1,0', // ENUM validation
        ]);
